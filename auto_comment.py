...
from .. import loader, utils
 ...
 @loader.module(name="autocomment") class НазваниеMod(loader.Module): """первый коммент""" async def имякомандыcmd(self, app: Client, message: types.Message): """.auto""" return await utils.answer( message, ".auto hui") @loader.on(lambda _, __, m: m and m.text == "text") async def watcher(self, app: Client, message: types.Message): return await message.reply( "text")
