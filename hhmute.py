...
class SwmuteMod(loader.Module):
    ...
    strings = {
        ...
        "muted": "🔇 <b>в муте клоун {user} for {time}</b>",
        "muted_forever": "🔇 <b>Swmuted {user} indefinitely</b>",
        "unmuted": "🔉 <b>выходи из мута from {user}</b>",
    ...
    strings_ru = {
        ...
        "muted": "🔇 <b>{user} клоун, ты в муте на {time}</b>",
        "muted_forever": "🔇 <b>{user} клоун навсегда</b>",
        "unmuted": "🔉 <b>{user} гуляй, сларк</b>",
